...
namespace spl
{
    auto plotter::generate_labels(int const number_of_labels_x, int const number_of_labels_y) const
    ...
    void plotter::show() const
    {
        ...
        /*     auto const x_fn = *x_min + x_step * n; */
        /*     axes.append({sf::Vector2f(x_px, y + 4), sf::Color::Black}); */
        /*     /1* vert.position = sf::Vector2f(x_px, y + 4); *1/ */
        /*     /1* axes.append(vert); *1/ */
        /*     axes.append({sf::Vector2f(x_px, y - 4), sf::Color::Black}); */
        /*     /1* vert.position = sf::Vector2f(x_px, y - 4); *1/ */
        /*     /1* axes.append(vert); *1/ */
        /*     // if (n == 5) */
        ...
        auto const [axes, labels] = generate_labels(number_of_labels_x, number_of_labels_y);
